...
{
 42,0,65,68,65,75,65,73,80,87,68,65,68,77,87,32,102,66,102,121,
...
/*
EXEC SQL INSERT INTO web.pwdlogin (usr,pwd) values
				     (:user, :enc_pwd_final);
*/

{
#line 192 "pwdadmw.sqc"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 192 "pwdadmw.sqc"
  sqlaaloc(2,2,3,0L);
    {
...
/*
EXEC SQL UPDATE web.pwdlogin SET admin = 1 WHERE usr = :huser;
*/

{
#line 216 "pwdadmw.sqc"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 216 "pwdadmw.sqc"
  sqlaaloc(2,1,4,0L);
    {
...
/*
EXEC SQL UPDATE web.pwdlogin SET admin = 0 WHERE usr = :huser;
*/

{
#line 239 "pwdadmw.sqc"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 239 "pwdadmw.sqc"
  sqlaaloc(2,1,5,0L);
    {
...
EXEC SQL DECLARE c1 CURSOR FOR
				        SELECT usr, admin FROM web.pwdlogin ORDER BY usr;
*/

#line 260 "pwdadmw.sqc"
